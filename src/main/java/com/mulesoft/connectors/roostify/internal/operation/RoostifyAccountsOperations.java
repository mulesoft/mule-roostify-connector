...
import com.mulesoft.connectors.roostify.internal.services.AccountsService;
import com.mulesoft.connectors.roostify.internal.services.AccountsServiceImpl;
...
public class RoostifyAccountsOperations extends ConnectorOperations<RoostifyConfiguration, RoostifyConnection, AccountsService> {
     ...
     * @return Json response containing list of all accounts
     */
     ...
     * @return Json response containing an account detail.
     */
