...
import static com.mulesoft.connectors.roostify.internal.util.Urls.SETTINGS;

public class SettingsServiceImpl extends DefaultConnectorService<RoostifyConfiguration, RoostifyConnection> implements SettingsService {

	public SettingsServiceImpl(RoostifyConfiguration config, RoostifyConnection connection) {
		super(config, connection);
	}

	@Override
	public Result<InputStream, ResponseStatus> retrievingSettings() {
		String strUri = getConfig().getAddress() + getConfig().getVersion() + SETTINGS;
