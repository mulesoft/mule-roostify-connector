...
import com.mulesoft.connectors.roostify.internal.services.LoanApplicationService;
import com.mulesoft.connectors.roostify.internal.services.LoanApplicationServiceImpl;
...
public class RoostifyLoanApplicationsOperations extends ConnectorOperations<RoostifyConfiguration, RoostifyConnection, LoanApplicationService> {
	 ...
	 * @return Json response containing list of all loan applications
	 */
	 ...
	 * @return Json response containing a loan application
	 */
	 ...
	 * @return FNM format of a loan application
	 */
	 ...
	 * @param connection   Roostify connection  instance.
	 * @param id    ID of the loan application to retrieve.
	 * @return MISMO format of a loan application
	 */
	 ...
	 * @return Json response containing a new loan application
	 */
	 ...
	 * @return Json response containing a updated loan application
	 */
