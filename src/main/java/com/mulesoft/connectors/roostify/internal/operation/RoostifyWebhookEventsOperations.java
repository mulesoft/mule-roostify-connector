...
import com.mulesoft.connectors.roostify.internal.services.WebhookEventsService;
import com.mulesoft.connectors.roostify.internal.services.WebhookEventsServiceImpl;
...
public class RoostifyWebhookEventsOperations extends ConnectorOperations<RoostifyConfiguration, RoostifyConnection, WebhookEventsService> {
	 ...
	 * @return Json response containing list of all webhook events
	 */
