 ...
 */
package com.mulesoft.connectors.roostify.internal.connection;

import com.mulesoft.connectors.roostify.api.proxy.DefaultHttpProxyConfig;
import com.mulesoft.connectors.roostify.internal.auth.CreateAuthentication;
import com.mulesoft.connectors.roostify.internal.connection.provider.param.ConnectionParameterGroup;
import com.mulesoft.connectors.roostify.internal.error.exception.ExceptionHandler;
import com.mulesoft.connectors.roostify.internal.error.exception.RoostifyConnectorException;
import com.mulesoft.connectors.roostify.internal.config.RoostifyConfiguration;
import com.mulesoft.connectors.roostify.internal.util.Urls;
import org.mule.runtime.api.connection.*;
import org.mule.runtime.extension.api.annotation.Alias;
import org.mule.runtime.extension.api.annotation.Expression;
import org.mule.runtime.extension.api.annotation.param.*;
import com.mulesoft.connectors.roostify.internal.connection.provider.RoostifyConnectionProvider;
...
import static com.mulesoft.connectors.roostify.internal.util.Constants.ROOSTIFY_CONFIGURATION;
...
public class RoostifyConnectionForAllServices extends RoostifyConnectionProvider {
    ...
    public RoostifyConnection connect() throws ConnectionException {
        ...
        HttpClient httpClient = httpService.getClientFactory().create(new HttpClientConfiguration.Builder()
                ...
                .setName(ROOSTIFY_CONFIGURATION)
                .build());
        httpClient.start();
    ...
    public ConnectionValidationResult validate(RoostifyConnection connection) {
        String address = RoostifyConfiguration.getAddressValue();
        String version = RoostifyConfiguration.getVersionValue();
        String strUri = address + version  + Urls.LOAN_APPLICATIONS;
        ...
        try {
            if (response.get().getStatusCode() != 200) {
                ...
                return ConnectionValidationResult.failure(str, new RoostifyConnectorException(response.get().getReasonPhrase(), ExceptionHandler.getError(response.get().getStatusCode())));
            }
        } catch (Exception e) {
